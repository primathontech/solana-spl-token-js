...
import secret from "./owner-wallet.json";

// const endpoint = 'https://example.solana-devnet.quiknode.pro/000000/'; //Replace with your RPC Endpoint
const endpoint =
  process.env.RPC_URL || ("https://api.devnet.solana.com" as string);
...
const MY_TOKEN_METADATA: UploadMetadataInput = {
  name: "FUN",
  symbol: "$FUN",
  description: "A sample token creation test",
  image: "https://picsum.photos/200/200", //add public URL to image you'd like to use
  external_url: "https://primathon.in/",
};
...
const ON_CHAIN_METADATA = {
  ...
  uri: "https://primathon.in/",
  sellerFeeBasisPoints: 0,
  creators: [
    {
      address: new PublicKey(process.env.PUB_KEY as string),
      verified: true,
      share: 100,
    },
  ],
